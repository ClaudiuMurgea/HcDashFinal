                    ...
                    <div class="row">
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input wire:model="city" class="form-control" type="text" placeholder="City...">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input wire:model="zip" class="form-control" type="text" placeholder="Zip...">
                    ...
                    <div class="row">
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input wire:model="phone" class="form-control" type="text" name="phone" placeholder="Phone...">
                    ...
                    <div class="row">
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input wire:model="color" id="colorPicker" class="form-control" type="text" placeholder="Color...">
