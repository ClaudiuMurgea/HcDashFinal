...
Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])  ->name('home');
    ...
    #Livewire Route
    Route::get('/user',                 LiveUser::class)          ->name('livewire.user')->middleware ('role:Platform Admin|Regional Admin');
    Route::get('/companies',            LiveCompany::class)       ->name('livewire.company');
    Route::get('/facilities/{company}', LiveFacility::class)      ->name('livewire.facility');
    Route::get('/regions',              LiveRegion::class)        ->name('livewire.region');
    Route::get('/displays',             LiveDisplay::class)       ->name('livewire.display');
